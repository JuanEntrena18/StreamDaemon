...
| **36** | **🌍 Traducción multi-idioma** — Frontend traducido a inglés, francés, alemán, italiano y español con detección automática del idioma del navegador (`navigator.languages`) y persistencia en localStorage. Interfaz unificada en ConfigPanel con iconos de banderas. | ✅ |
