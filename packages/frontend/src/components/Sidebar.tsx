...
export type Tab = 'dashboard' | 'tracker' | 'kpi' | 'security' | 'chat' | 'mod' | 'commands' | 'subathon' | 'giveaway' | 'prediction' | 'hud' | 'timer' | 'scoreboard' | 'obs' | 'builder' | 'config' | 'bitrate' | 'vertical' | 'alertsounds' | 'avatars' | 'speedrun' | 'calendar';
