...
export interface PathToAffiliate {
  averageViewers: QuestGoal;
  followers: QuestGoal;
  hoursStreamed: QuestGoal;
  uniqueDaysStreamed: QuestGoal;
  completedAt: string | null;
  affiliateInvitationStatus: string | null;
  badgeURL: string | null;
}

export interface PathToPartner {
  averageViewers30: QuestGoal;
  averageViewers60: QuestGoal;
  uniqueDaysStreamed: QuestGoal;
  completedAt: string | null;
  affiliateInvitationStatus: string | null;
}

export interface BuildACommunity {
  enabled: QuestGoal;
  communityServer: QuestGoal;
  hostedCommunityEvents: QuestGoal;
  completedAt: string | null;
}
...
export interface AchievementsResponse {
  ...
  avatarUrl: string | null;
  quests: {
    pathToAffiliate: PathToAffiliate | null;
    pathToPartner: PathToPartner | null;
    buildACommunity: BuildACommunity | null;
  } | null;
}
