...
- **🖥️ Premium dashboard** — Interface with collapsible sidebar (expands from 56px icons to 220px full navigation), responsive drawer mode on mobile with hamburger menu, glassmorphism, Framer Motion animations, purple/indigo palette, Twitch user badge and real-time connection status.
