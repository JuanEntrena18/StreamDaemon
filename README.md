...
- **🖥️ Premium dashboard** — Interface with sidebar navigation, glassmorphism, Framer Motion animations, purple/indigo palette, Twitch user badge and real-time connection status.
